...
namespace Shared
{
    public enum Options
    {
        ...
        INACTIVE_FRIENDS = 22,              //  SERVER ONLY                                                 Option:22$$Data:<JSONUsername>$$
        FRIEND_INVITATIONS = 23,            //  SERVER ONLY                                                 Option:23$$Data:<JSONInvitations>$$
        INCOMMING_CALL = 24,                //  SERVER ONLY                                                 Option:24$$Data:<JSONCall>$$
        ACCEPTED_CALL = 25,                 //  SERVER ONLY                                                 Option:25$$Data:<Username>$$
        DECLINED_CALL = 26,                 //  SERVER ONLY                                                 Option:26$$Data:<Username>$$
